...
- Start `Service Discovery` server in development mode using the following command (skipping execution of test cases):
...
`Service Discovery` also provides configuration to use the native file system as the persistent backend.
