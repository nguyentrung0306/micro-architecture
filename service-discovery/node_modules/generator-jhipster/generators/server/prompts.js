...
function askForServerSideOpts(meta) {
    ...
    const prompts = [
        ...
        },
        {
            ...
            choices: [
                {
                    value: 'eureka',
                    name: 'Service Discovery (uses Eureka, provides Spring Cloud Config support and monitoring dashboards)',
                },
                {
                    value: 'consul',
                    name: 'Consul',
        ...
        },
        {
            ...
            type: 'list',
            name: 'serviceDiscoveryType',
            message: 'Do you want to use the Service Discovery to configure, monitor and scale your application?',
            choices: [
                {
                    value: false,
                    name: 'No',
    ...
    this.prompt(prompts).then(props => {
        ...
        // JWT authentication is mandatory with Eureka, so the Service Discovery
