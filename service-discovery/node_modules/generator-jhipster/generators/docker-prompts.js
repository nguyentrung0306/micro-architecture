...
function askForServiceDiscovery() {
    ...
    if (serviceDiscoveryEnabledApps.every(app => app.serviceDiscoveryType === 'consul')) {
        ...
        this.log(chalk.green('Service Discovery detected as the service discovery and configuration provider used by your apps'));
        done();
    } else {
    ...
    const prompts = [
        {
            type: 'input',
            name: 'adminPassword',
            message: 'Enter the admin password used to secure the Service Discovery',
            default: 'admin',
